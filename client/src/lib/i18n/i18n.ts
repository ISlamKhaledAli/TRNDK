...
const resources = {
  en: {
    common: {
      ...
      footer: {
        ...
        allServices: "All Services",
        aboutUs: "About Us",
        ourWorkGallery: "Business Gallery",
      },
      status: "Status",
      actions: "Actions",
      view: "View",
    ...
    serviceDetails: {
      ...
      descriptionPlaceholder: "Describe your project requirements here... (Optional)",
  ...
  ar: {
    ...
    serviceDetails: {
      ...
      descriptionPlaceholder: "اشرح متطلبات مشروعك هنا... (اختياري)",
