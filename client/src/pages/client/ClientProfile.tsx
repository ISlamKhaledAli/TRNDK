        ...
        <div className="space-y-6">
          <div className="bg-card rounded-xl border border-border p-6 card-shadow">
            <div className="text-center mb-4">
              ...
              <p className="text-sm text-muted-foreground">{user?.isVip ? t("dashboard.memberStatus") : t("common:userMenu.user")}</p>
            </div>
            <div className="space-y-3 text-sm">
              <div className="flex justify-between p-3 bg-secondary/50 rounded-lg">
                <span className="text-muted-foreground">{t("profile.orders")}</span>
                <span className="font-bold text-foreground">{dashboard?.totalOrders || 0}</span>
              </div>
              <div className="flex justify-between p-3 bg-secondary/50 rounded-lg">
